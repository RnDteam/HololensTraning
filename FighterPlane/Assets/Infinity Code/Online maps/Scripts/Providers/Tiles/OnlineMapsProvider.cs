...
public class OnlineMapsProvider
{
        ...
        providers = new []
        {
            ...
            new OnlineMapsProvider("google", "Google Maps")
            {
                ...
                _types = new[]
                {
                    new MapType(SATELLITE)
                    {
                        ...
                        urlWithoutLabels = "https://khm{rnd0-3}.googleapis.com/kh?v=708&hl={lng}&x={x}&y={y}&z={zoom}",
                    },
                    new MapType(RELIEF)
                    {
            ...
            new OnlineMapsProvider("virtualearth", "Virtual Earth (Bing Maps)")
            {
                ...
                _types = new []
                {
                    new MapType("Aerial")
                    {
                        urlWithoutLabels = "https://ak.t{rnd0-4}.tiles.virtualearth.net/tiles/a{quad}.jpeg?mkt={lng}&g=1457&n=z",
                        urlWithLabels = "https://ak.dynamic.t{rnd0-4}.tiles.virtualearth.net/comp/ch/{quad}?mkt={lng}&it=A,G,L,LA&og=30&n=z"
                    },
                    new MapType("Road")
                    {
                        urlWithLabels = "https://ak.dynamic.t{rnd0-4}.tiles.virtualearth.net/comp/ch/{quad}?mkt={lng}&it=G,VE,BX,L,LA&og=30&n=z"
                    }
                }
            },
    ...
    public class MapType
    {
        ...
        {
            if (provider.extraFields == null) return false;
