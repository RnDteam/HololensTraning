...
public class OnlineMapsHereRoutingAPI: OnlineMapsTextWebService
{
    ...
    public class GeoWaypoint: Waypoint
    {
        ...
        public override void GetURLKey(StringBuilder builder)
        {
            ...
            if (altitude.HasValue) builder.Append(",").Append(altitude.Value);
    ...
    public class LinkWaypoint : Waypoint
    {
        ...
        public override void GetURLKey(StringBuilder builder)
        {
            ...
            if (displayLatitude.HasValue && displayLongitude.HasValue)
            {
                ...
                if (displayAltitude.HasValue) builder.Append(",").Append(displayAltitude.Value);
            }
        ...
        public void GetURLKey(StringBuilder builder)
        {
            ...
            if (avoidAreas != null)
            {
                ...
                for (int i = 0; i < avoidAreas.Length; i++)
                {
                    ...
                    builder.Append(area.top).Append(",").Append(area.left).Append(";").Append(area.bottom).Append(",").Append(area.right);
            ...
            if (viewBounds != null) builder.Append("&viewBounds=").Append(viewBounds.top).Append(",").Append(viewBounds.left).Append(";").Append(viewBounds.bottom).Append(",").Append(viewBounds.right);
            ...
            if (generalizationtolerances != null)
            {
                ...
                builder.Append("&generalizationtolerances=").Append(generalizationtolerances[1]).Append(",").Append(generalizationtolerances[0]);
            }
    ...
    public class StreetWaypoint : Waypoint
    {
        ...
        public override void GetURLKey(StringBuilder builder)
        {
            ...
            builder.Append("!").Append(streetLatitude).Append(",").Append(streetLongitude);
            if (streetAltitude.HasValue) builder.Append(",").Append(streetAltitude.Value);
    ...
    public class VehicleType
    {
        ...
        public void GetURLKey(StringBuilder builder)
        {
            ...
            if (averageConsumption.HasValue) builder.Append(",").Append(averageConsumption.Value);
        }
    }
